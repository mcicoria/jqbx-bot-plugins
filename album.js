...
var AlbumPlugin = function(data){
    ...
    function getAlbum(user){
        ...
        //From spotify:album:7g1sDNM38oSf0IUB6Irb0k to https://open.spotify.com/album/7g1sDNM38oSf0IUB6Irb0k
        if(AlbumLink) AlbumLink = AlbumLink.replace("spotify:album:","https://open.spotify.com/album/");
        ...
        if (!AlbumName){
            ...
            that.bot.emit("do:commandResponseExpandable", "The song " + SongName + " is from the album " + AlbumName + ": " + AlbumLink);
        }
